 ...
 */
imageArea.prototype.getFolder = function () {
	var folder = null;
...
/**
	...
	getFilename below
*/
imageArea.prototype.retryFilename = prototypeMethods.retryFilename;

/**
	Gets a filename for uploaded files based on the adapter options
*/
imageArea.prototype.getFilename = prototypeMethods.getFilename;

imageArea.prototype.fileExists = function (filename, callback) {
	var cloudinary = require('cloudinary');
 ...
 * @api public
 */
imageArea.prototype.getRequestHandler = function (item, req, paths, callback) {
