...
import Thumbnail from './EclainaryImagesThumbnail';
...
module.exports = Field.create({
	displayName: 'EclainaryImagesField',
	statics: {
		type: 'EclainaryImages',
		getDefaultValue: () => ([]),
	},
	getInitialState () {
	...
	buildInitialState (props) {
		const uploadFieldPath = `EclainaryImages-${props.path}-${++uploadInc}`;
	...
	renderUI () {
		...
		return (
			<FormField label={label} className="field-type-eclainaryimages" htmlFor={path}>
				<div>
					{thumbnails}
				</div>
